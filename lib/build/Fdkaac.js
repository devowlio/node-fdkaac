...
import { existsSync as fsExistsSync, readFile as fsReadFile, writeFile as fsWriteFile, unlink as fsUnlink } from "fs";
    ...
    execEncode(inputFilePath) {
        ...
        return new Promise((resolve, reject) => {
            this.emitter.on("finish", () => {
                ...
                if (this.options.output == "buffer") {
                    fsReadFile(this.encodedBufferTempFilePath, null, (error, data) => {
